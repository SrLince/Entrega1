...
const EditarEstrategia = () => {
    ...
    const cargarEstrategia = async () => {
        const result = await Axios.get(`http://localhost:3001/api/estrategias/${id}`, estrategia);
        setSelectedMethod(result.data[0].metodo);
        setEstrategia(result.data[0]);
    };
    ...
    return ( 
      ...
      <div className='container mt-5 mb-5'>
          <div className='w-75 mx-auto shadow p-5'>
              <h2 className='text-center mb-4'>Editar Estrategia</h2>
              <form onSubmit={e => onSubmit(e)}>
                  ...
                  <div className='form-group'>
                      ...
                      placeholder='Ingrese condiciones de activación' name='condicion' value={condicion} onChange={e => onInputChange(e)} />
                  </div>
                  <div className='form-group'>
                  ...
                  <div className='mb-5 mt-5 d-flex justify-content-end'>
                      ...
                      <button className='btn dark-bg btn-block ms-5'>Editar Estrategia</button>
                  </div>
              </form>
          </div>
      </div>
...
export default EditarEstrategia;